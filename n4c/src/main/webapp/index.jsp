...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-8 mx-auto text-center mb-5">
                    <p class="text-uppercase text-rounded font-weight-300 mx-auto text-center my-5">News</p>
    ...
    <section class="brand-ai-section">
        <div class="container">
            <h2 class="text-center py-5 text-uppercase font-weight-light spacing-1">Brands that use AI</h2>
